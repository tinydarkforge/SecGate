...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .kpis { display: grid; grid-template-columns: repeat(8, 1fr); gap: 12px; margin: 24px 0; }
...
<div class="wrap">
  ...
  <div class="kpis">
    <div class="kpi"><div class="label">Security Score</div><div class="value" style="color:${(rep.securityScore ?? 100) >= 90 ? "#34c759" : (rep.securityScore ?? 100) >= 70 ? "#ff9500" : "#ff3b30"}">${e(rep.securityScore ?? "—")}<span style="font-size:14px;color:#8e8e93"> / 100</span></div></div>
